...
tmux_session_info+=(["foreground"]="colour230")
...
hostname+=(["foreground"]="colour230")
hostname+=(["background"]="colour236")
...
vcs_branch+=(["foreground"]="colour0")
vcs_branch+=(["background"]="colour235")
...
vcs_modified+=(["foreground"]="colour249")
vcs_modified+=(["background"]="colour235")
vcs_modified+=(["separator_fg"]="colour237")
